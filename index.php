...
<body>
			...
			<div class="item active">
				<div class="container">
					<div class="carousel-caption">
						<h6>Welcome To Cave Institutions</h6>
						<h3>Leading
							<span>University</span>
						</h3>
						<p>CENTRE FOR ACADEMIC VISION EXCELLENCE</p>
					</div>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="welcome-sub-wthree">
				<div class="col-md-12 banner_bottom_left">
					<h4>About
						<span>Cave Institutions</span>
					</h4>
					<p>In the education market where rankings and toppers matter the most, our institution is providing
						another opportunity for those left out students who are considered as “failure” by the society.
						Following points would further suffice: We, at CAVE, are - Striving to improve the human
						resource of this country.</p>
					<p>Moral upliftment of those students who would otherwise have all the options to pick up anti
						social elements following his/ her failure.
					...
					<p>We at CAVE, offer 2 programmes for 10th std and 2nd PUC failed students respectively. Under
						...
						std failed subjects along with basics of I PUC. By the end of one year, students will be able to
						clear their 10th std board exam as well as I PUC at our institution. This enables them to go for
						II PUC successfully without wasting one year.

						Likewise, II PUC failed students will be admitted to BCom Open Learning Programme, where they
						will be given two years to clear their II PUC board exams and enter final year BCom
						successfully. Apart from these flagship programmes, CAVE Institutions will be offering coaching
						for various competitive exams from the next academic year.</p>
					<h4 class="about-second">Where Do We See Ourselves After 2 Years</h4>
					<p>With the success of one academic year, we are able to expand our institution to three new
						branches in and around Bengaluru. Continuing this journey of ours, we would be glad to expand
						our student community.</p>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="wrimagecard wrimagecard-topimage">
					...
					<div class="wrimagecard-topimage_title">
						<h3 class="mb">Our Mision</h3>
						<ul>
							<li class="card-list">To excel in academics through interactive session</li>
							<li class="card-list">To place academic commitment as our top priority</li>
							<li class="card-list">To eliminate obstacles in learning by introducing better learning
								methodology</li>
							<li class="card-list">To provide excellent coaching for professional enhancement</li>
							<li class="card-list">To promote exchange of ideas through online and offline mode</li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="wrimagecard wrimagecard-topimage">
					...
					<div class="wrimagecard-topimage_title">
						<h3 class="mb">Our Vision</h3>
						<p>To be a well recognized coaching institution in the country that offers a transformative
							education to create future leaders and innovators, who will be the backbone of the growth of
							the economy. The vision is always to be actively engaged in Knowledge Management and
							Knowledge Transformation which will help the connected stakeholders.</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="services-moksrow">
				...
				<div class="col-xs-4 services-grids-w3l">
					<div class="servi-shadow">
						...
						<h4>Prayer Hall</h4>
						<p>Prayer hall is opened for whom, who needs to pray based on background of cultures and religions. </p>
					</div>
				</div>
				<div class="col-xs-4 services-grids-w3l">
					<div class="servi-shadow">
			...
			<div class="services-moksrow">
				<div class="col-xs-4 services-grids-w3l">
					<div class="servi-shadow">
						...
						<h4>Best Teachers</h4>
						<p> We provide excellent teaching faculty with highly qualified and well experienced staff. </p>
					</div>
				</div>
				<div class="col-xs-4 services-grids-w3l">
					<div class="servi-shadow">
				...
				<div class="col-xs-4 services-grids-w3l">
					<div class="servi-shadow">
						...
						<p>All events/news within the campus are updated in social sites. The institute provides the
							link to access these
							sites.</p>
					</div>
				</div>
				<div class="clearfix"> </div>
				...
				<div class="modal-body">
					<div class="model-img-info">
						...
						<p>Duis venenatis, turpis eu bibendum porttitor, sapien quam ultricies tellus, ac rhoncus risus
							odio eget nunc. Pellentesque
							ac fermentum diam. Integer eu facilisis nunc, a iaculis felis. Pellentesque pellentesque
							tempor enim, in dapibus turpis
	...
	<div class="middle-sec-agile">
		<div class="container">
			<h4>
				<span>Cave</span> Institutions</h4>
			<ul>
				<li>
				...
				<li>
					...
					<div class="middle-right">
						<h5>Failed an exam? Find out what to do next!</h5>
						<p></p>
					</div>
					<div class="clearfix"></div>
				</li>
